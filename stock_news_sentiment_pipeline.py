...
PROJECT_DIR = Path(os.environ.get("PROJECT_DIR", Path(__file__).resolve().parent)).resolve()
...
with DAG(
    ...
    # Six models (logically parallel; SequentialExecutor runs them sequentially)
